...
class Game:
    ...
    def start_text(self):
        font = pygame.font.Font('OriginTech personal use.ttf', 150)
        text = font.render('SPACE WAR', True, 'orange')
        text_rect = text.get_rect(center=(s_width/2, s_height/2-80))
        screen.blit(text, text_rect)
        font1 = pygame.font.Font('OriginTech personal use.ttf', 50)
        font2 = pygame.font.SysFont('Calibri', 20)
        text1 = font1.render('Click ENTER', True, 'grey')
        text2 = font2.render('Abdi Maskur Mutaqin, Bayu Agaluh Wijaya, Rozan Zaki, Gaberia Sinaga, Elisabet Nandra', True, 'white')
